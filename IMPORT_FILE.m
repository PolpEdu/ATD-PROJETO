function accexp11user06 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ACCEXP11USER06 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ACCEXP11USER06 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   accexp11user06 = importfile('acc_exp11_user06.txt', 1, 16522);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/03/22 15:24:07

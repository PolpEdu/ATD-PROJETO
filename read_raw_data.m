function accexp20user10 = read_raw_data(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ACCEXP20USER10 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   ACCEXP20USER10 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   accexp20user10 = importfile('acc_exp20_user10.txt', 1, 11601);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/04/02 18:35:58
...
accexp20user10 = [dataArray{1:end-1}];
